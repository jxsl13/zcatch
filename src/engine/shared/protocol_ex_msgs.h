...
// Example:
//
// 1) `i-unfreeze-you@teeworlds.com`
// 2) `creeper@minetee`
//
// The first example applies if you own the `teeworlds.com` domain, that is, if you
...
UUID(NETMSG_WHATIS,       "what-is@teeworlds.com")
UUID(NETMSG_ITIS,         "it-is@teeworlds.com")
UUID(NETMSG_IDONTKNOW,    "i-dont-know@teeworlds.com")

UUID(NETMSG_RCONTYPE,     "rcon-type@teeworlds.com")
UUID(NETMSG_MAP_DETAILS,  "map-details@teeworlds.com")
UUID(NETMSG_TIME_SCORE,   "time-score@teeworlds.com")
