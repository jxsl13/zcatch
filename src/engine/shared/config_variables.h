...
MACRO_CONFIG_INT(SvTeeHistorian, sv_teehistorian, 0, 0, 1, CFGFLAG_SERVER, "Enable TeeHistorian logging. Logs every player input into a highly compressible file format.")
