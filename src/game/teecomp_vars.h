...
MACRO_CONFIG_INT(TcColoredTeesTeam1, tc_colored_tees_team1, 16739179, -1, 16777215, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Red team/team mates color") // TODO: move this hack to static vars
MACRO_CONFIG_INT(TcColoredTeesTeam2, tc_colored_tees_team2, 7053311, -1, 16777215, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Blue team/enemies color")
MACRO_CONFIG_INT(TcColoredTeesTeam1Hsl, tc_colored_tees_team1_hsl, 16739179, -1, 16777215, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Red team/team mates color")
MACRO_CONFIG_INT(TcColoredTeesTeam2Hsl, tc_colored_tees_team2_hsl, 16739179, -1, 16777215, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Red team/team mates color")
