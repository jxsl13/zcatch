...
// MACRO_CONFIG_INT(TcStatboardInfos, tc_statboard_infos, 1259, 1, 2047, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Mask of infos to display on the global statboard") // now clstatboardinfos
