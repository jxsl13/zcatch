...
image_gamericon = Image("gamericon", "gamer_icon.png", 1)
...
container.images.Add(image_gamericon)
...
set_gamericon = SpriteSet("gamericon", image_gamericon, 1, 1)
...
container.spritesets.Add(set_gamericon)
...
container.sprites.Add(Sprite("gamericon", set_gamericon, 0,0,1,1))
